...
type QueryCountry struct {
	...
	Language     []Language    `json:"languages,omitempty" bson:"languages,omitempty"`
	Translations []Translation `json:"translations,omitempty" bson:"translations,omitempty"`
	Currencies   []Currency    `json:"currencies,omitempty" bson:"currencies,omitempty"`
}
